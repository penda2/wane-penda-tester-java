...
public class DBConstants {
    ...
    public static final String GET_VEHICLE_REG_NUMBER = "SELECT VEHICLE_REG_NUMBER, COUNT(*) as numberOfTickets FROM test.ticket group by VEHICLE_REG_NUMBER HAVING COUNT(*) > 1";
}
