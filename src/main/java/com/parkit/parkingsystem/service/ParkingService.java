...
public class ParkingService {
	...
	public void processIncomingVehicle() {
		try {
			...
			if (parkingSpot != null && parkingSpot.getId() > 0) {
				...
				System.out.println(
						"Good to see you again! As a regular user of our parking lot, you will get a 5% discount");
	...
	//recurrence of a vehicle by checking the number of occurrences of its registration number in the database     *
